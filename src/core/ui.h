...
private:
	// Modified theme from https://github.com/ocornut/imgui/issues/707#issuecomment-917151020
	void setTheme()
	{
		...
		colors[ImGuiCol_ChildBg]                = ImVec4(0.05f, 0.05f, 0.05f, 0.40f);
		...
		colors[ImGuiCol_TitleBg]                = ImVec4(0.13f, 0.07f, 0.05f, 1.00f);
		colors[ImGuiCol_TitleBgActive]          = ImVec4(0.27f, 0.14f, 0.11f, 1.00f);
		colors[ImGuiCol_TitleBgCollapsed]       = ImVec4(0.13f, 0.07f, 0.05f, 0.80f);
		...
		colors[ImGuiCol_SliderGrab]             = ImVec4(0.82f, 0.72f, 0.66f, 0.34f);
		colors[ImGuiCol_SliderGrabActive]       = ImVec4(0.90f, 0.79f, 0.73f, 0.34f);
		...
		colors[ImGuiCol_Separator]              = ImVec4(0.82f, 0.72f, 0.66f, 1.00f);
		colors[ImGuiCol_SeparatorHovered]       = ImVec4(0.82f, 0.72f, 0.66f, 1.00f);
		colors[ImGuiCol_SeparatorActive]        = ImVec4(0.90f, 0.79f, 0.73f, 1.00f);

		colors[ImGuiCol_ResizeGrip]             = ImVec4(0.82f, 0.72f, 0.66f, 0.29f);
		colors[ImGuiCol_ResizeGripHovered]      = ImVec4(0.90f, 0.79f, 0.73f, 0.29f);
		colors[ImGuiCol_ResizeGripActive]       = ImVec4(0.90f, 0.79f, 0.73f, 1.00f);

		colors[ImGuiCol_Tab]                    = ImVec4(0.34f, 0.20f, 0.15f, 1.00f);
		colors[ImGuiCol_TabHovered]             = ImVec4(0.65f, 0.33f, 0.27f, 1.00f);
		colors[ImGuiCol_TabSelected]            = ImVec4(0.55f, 0.29f, 0.23f, 1.00f);
		colors[ImGuiCol_TabDimmed]              = ImVec4(0.28f, 0.14f, 0.11f, 1.00f);
		colors[ImGuiCol_TabDimmedSelected]      = ImVec4(0.50f, 0.26f, 0.21f, 1.00f);

		colors[ImGuiCol_TabDimmedSelectedOverline] = ImVec4(0.82f, 0.72f, 0.66f, 0.00f);
		colors[ImGuiCol_TabSelectedOverline]    = ImVec4(0.90f, 0.79f, 0.73f, 1.00f);

		colors[ImGuiCol_PlotLines]              = ImVec4(0.82f, 0.72f, 0.66f, 1.00f);
		colors[ImGuiCol_PlotLinesHovered]       = ImVec4(0.82f, 0.72f, 0.66f, 1.00f);
		colors[ImGuiCol_PlotHistogram]          = ImVec4(0.82f, 0.72f, 0.66f, 1.00f);
		colors[ImGuiCol_PlotHistogramHovered]   = ImVec4(0.82f, 0.72f, 0.66f, 1.00f);
